...
export default function Home() {
  ...
  return (
    <div className="bg-light-mode-1 text-dark-mode-1 dark:bg-dark-mode-1 text dark:text-white text-lg tracking-wide flex flex-col h-screen">
      ...
      <nav className="flex basis-[100%] max-sm:flex max-sm:flex-col">
        <ul className="ml-6 relative flex flex-col basis-[30%] gap-4 pt-4 bg-light-mode-2 dark:bg-dark-mode-2 max-sm:flex-row max-sm:basis-0 max-sm:pb-4 max-sm:ml-0 max-sm:gap-8">
