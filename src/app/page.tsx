...
export default function Home() {
  ...
  return (
    <div className="bg-[#EBEBEB] text-dark-mode-1 dark:bg-dark-mode-1 text dark:text-white text-lg tracking-wide flex flex-col justify-between h-screen">
      <DefaultHeader icon={setting} title="Configurações do console" />
      <div className="grid-cols-[1fr,2fr] max-sm:flex max-sm:flex-col">
        <ul className="ml-6 relative flex flex-col gap-4 pt-4 bg-light-mode-2 dark:bg-dark-mode-2 max-sm:flex-row max-sm:pb-4 max-sm:ml-0 max-sm:gap-8">
          <li
            className="cursor-pointer max-sm:pl-14"
            onClick={() => setMenu("temas")}
          >
            {menu === "temas" && (
            ...
            <p
              ...
              } font-normal pl-14 dark:font-light dark:tracking-[0.05em] max-sm:px-2`}
            >
              Temas
            </p>
            {menu === "temas" && (
