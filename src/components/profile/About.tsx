  ...
  return (
    <article className="flex flex-col pt-4">
      <div className="flex items-center pb-1">
        ...
        <h2 className="text-base text-light-text-2 font-normal mx-3 dark:text-dark-mode-2 flex justify-between w-full">
          Quem é taby
          <span>
            <Image
              src="/question.svg"
      ...
      <p className="text-xl font-normal p-3 dark:font-light dark:tracking-[0.05em]">
