    ...
    <article className="flex gap-4 w-full">
      ...
      <div className="w-full">
        ...
        <div className="flex justify-between py-3 px-4">
          <p className="text-3xl font-normal">Tabata Caroline Souto</p>
          <Image
            src="/edit.svg"
            width={20}
            height={20}
        ...
        <p className="text-lg font-normal py-6 px-4 dark:font-light dark:tracking-[0.05em]">
          Desenvolvedora Front-End | FullStack
        </p>
        <hr className="border-light-mode-2 dark:border-dark-mode-2" />
        <h2 className="text-base text-right text-light-text-2 font-normal ml-3  dark:text-dark-mode-2 pt-1">
